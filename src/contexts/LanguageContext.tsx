...
const translations = {
  'pt-BR': {
    ...
    'projects.hobbit.title': 'The Hobbit - 3D Interactive Book',
    'projects.hobbit.description': 'Experiência imersiva e interativa recriando um livro em 3D utilizando puramente CSS e Vanilla JavaScript, sem bibliotecas externas.',
    'projects.hobbit.impact': 'Renderização 3D nativa com HTML, CSS e JS',
    'projects.mario.title': 'Super Mario Runner',
    'projects.mario.description': 'Endless runner inspirado no clássico Super Mario Bros. Possui sistema de colisões, gravidade, vidas e áudio integrados.',
    'projects.mario.impact': 'Lógica de jogos em Vanilla JavaScript',
    'projects.strata_chat.title': 'StrataChat',
    'projects.strata_chat.description': 'Sistema de chat corporativo hierárquico distribuído com WebSockets, arquitetura em microsserviços autônomos, suporte offline-first (PWA) e consistência NoSQL.',
    'projects.strata_chat.impact': 'Sistemas Distribuídos - Engenharia de Computação',
    'projects.es_crud.title': 'ES-CRUD (Gestão de Supermercado)',
    'projects.es_crud.description': 'Plataforma Full Stack para gestão comercial de supermercados e PDV em tempo real, com controle de acesso por cargos (RBAC) e arquitetura limpa.',
    'projects.es_crud.impact': 'Engenharia de Software - Engenharia de Computação',
    ...
    'contact.available': 'Vamos transformar ideias em soluções reais',
  ...
  'en': {
    ...
    'hero.role3': 'Systems Development in PHP',
    'hero.cta': 'View Projects',
    'hero.scroll': 'Scroll to explore',

    'about.title': 'About Me',
    'about.description': 'Computer Engineering student at IFSULDEMINAS, interested in artificial intelligence, web development, and software engineering. I seek to develop well-structured, scalable, and maintainable solutions, applying best development practices and maintaining a constant learning process.',
    'about.journey': 'I value problem-solving, code organization, and building applications that deliver value and provide a good user experience.',
    'about.image_alt': 'Alessandro Augusto - Cartoon',
    'about.skills.frontend': 'Frontend',
    'about.skills.backend': 'Backend',
    ...
    'projects.hobbit.title': 'The Hobbit - 3D Interactive Book',
    'projects.hobbit.description': 'Immersive and interactive experience recreating a 3D book using purely CSS and Vanilla JavaScript, without external libraries.',
    'projects.hobbit.impact': 'Native 3D rendering with HTML, CSS, and JS',
    'projects.mario.title': 'Super Mario Runner',
    'projects.mario.description': 'Endless runner inspired by the classic Super Mario Bros. Features collision system, gravity, lives, and integrated audio.',
    'projects.mario.impact': 'Game logic in Vanilla JavaScript',
    'projects.strata_chat.title': 'StrataChat',
    'projects.strata_chat.description': 'Real-time distributed hierarchical corporate chat system with WebSockets, autonomous microservices architecture, offline-first support (PWA), and NoSQL consistency.',
    'projects.strata_chat.impact': 'Distributed Systems - Computer Engineering',
    'projects.es_crud.title': 'ES-CRUD (Supermarket Management)',
    'projects.es_crud.description': 'Full Stack platform for supermarket management and real-time POS, implementing role-based access control (RBAC) and clean layered architecture.',
    'projects.es_crud.impact': 'Software Engineering - Computer Engineering',
    ...
    'contact.available': "Let's turn ideas into real solutions",
